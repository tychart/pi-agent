/**
 * Public event contract for @juicesharp/custom-ask-for-clarification.
 *
 ...
 *      semantics) require a NEW channel, e.g. `custom-clarification:prompt.v2`,
...
export const ASK_USER_PROMPT_EVENT = "custom-clarification:prompt" as const;
 ...
 */
export const ASK_USER_BLOCKED_EVENT = "custom-clarification:blocked" as const;
