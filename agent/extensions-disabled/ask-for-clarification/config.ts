...
export interface AskForClarificationConfig {
...
export function resolveCollapseKey(config: Pick<AskForClarificationConfig, "collapseKey">): CollapseKeySpec {
...
export function loadConfig(): AskForClarificationConfig {
	return loadJsonConfigWithLegacyFallback<AskForClarificationConfig>("custom-ask-for-clarification");
}
