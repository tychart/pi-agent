/**
 * i18n bridge for custom-ask-for-clarification — single thin import surface so every
 ...
 *
 * - `t(key, fallback)` is `scope("@juicesharp/custom-ask-for-clarification")` if the
...
export const I18N_NAMESPACE = "@juicesharp/custom-ask-for-clarification";
